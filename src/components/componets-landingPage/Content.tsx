export function Content() {
  return (
    <section className="py-8 leading-7 text-gray-900bg-gradient-to-b from-white to-gray-50 sm:py-12 md:py-16 lg:py-24">
      <div className="max-w-6xl px-4 px-10 mx-auto border-solid lg:px-12">
        <div className="flex flex-col items-start leading-7 text-gray-900 border-0 border-gray-200 lg:items-center lg:flex-row">
          ...
          <a
            href="https://www.linkedin.com/in/wellington-henrique-batista-55a83556/recent-activity/shares/"
